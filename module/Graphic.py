...
class Graphic:
    ...
    def draw_tools(win, directory, tool_file, tool_coord):
    ...
    def draw_walls(win, directory, wall_coord):
    ...
    def draw_cara(win, directory, mac_position):
